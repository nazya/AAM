  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/nazya/AAM/blob/main/algorithms1.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "2013498a-e66f-4c2f-f8d9-01940ed80ede"
      },
      "source": [
        "import os # tedst\n",
        ...
        "repo_name = 'AALS-for-CP'\n",
        "\n",
        "cmd_string = 'git clone https://{0}:{1}@github.com/MerkulovDaniil/{2}.git'.format(user, password, repo_name)\n",
        "\n",
        "os.system(cmd_string)\n",
        "cmd_string, password = \"\", \"\" # removing the password from the variable\n",
        "os.system(f'mv -v /content/{repo_name}/* /content/')\n",
